...
# initial manuall inspection
# list.files("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset")
# list.files("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train")
##
#
# list.files("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals")
# list.files("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/subject_train.txt")
# list.files("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/x_train.txt")
# list.files("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/y_train.txt")

# signal_dir <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals")
# signal_train <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/subject_train.txt")
# signal_x <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/x_train.txt")
# signal_y <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/y_train.txt")

# signal directory content
# signal_dir_acc_x <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals/body_acc_x_train.txt")
# signal_dir_acc_y <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals/body_acc_y_train.txt")
# signal_dir_acc_Z <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals/body_acc_z_train.txt")

#signal_dir_gyro_x <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals/body_gyro_x_train.txt")
#signal_dir_gyro_y <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals/body_gyro_y_train.txt")
#signal_dir_gyro_z <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals/body_gyro_z_train.txt")

#signal_dir_total_x <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals/total_acc_x_train.txt")
#signal_dir_total_y <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals/total_acc_y_train.txt")
#signal_dir_total_z <- read.csv("Original_getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals/total_acc_z_train.txt")
# colnames(groupedData) <- sub("_std$","_standard_deviation", names(groupedData))
